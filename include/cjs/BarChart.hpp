...
class BarChart  
{
    public:
        ...
        inline void SetBeginAtZero(const bool isBeginAtZero) { m_beginAxisAtZero = isBeginAtZero; };
        ...
        inline void SetStackBothAxes(const bool bothAxis) {m_stackXAxis = bothAxis; m_stackYAxis = bothAxis; }
        inline void SetStackXAxis(const bool stackXAxis) { m_stackXAxis = stackXAxis; }
        inline void SetStackYAxis(const bool stackYAxis) { m_stackYAxis = stackYAxis; }
